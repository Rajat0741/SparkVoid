import { findMessagesByConversationId, insertMessage, linkPendingAttachments, updateConversationTimestamp } from "@/lib/db/queries";
...
export const prepareMessages = async (userId: string, conversationId: string, message: CustomUIMessage): Promise<PreparedMessages> => {
    ...
    await linkPendingAttachments(userId, message.id, conversationId, newAttachmentUrls)
